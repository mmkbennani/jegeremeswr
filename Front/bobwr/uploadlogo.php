		  ...
		  <header class="panel-heading wht-bg">
			...
			<div class="nav-tabs-wrapper md-tabs ">
				<ul class="nav nav-tabs nav-justified" id="nav_tabs" data-tabs="tabs">
					...
					<li>
					  <a class="nav-link" href="#upload_logo" data-toggle="tab">
						<i class="fa fa-upload">  Upload logo</i> 
					  </a>
					</li>
				</ul>
			</div>
			  ...
			  <div class="tab-content">
                    <div class="tab-pane active" id="alphanum">
                      <form>
						...
						<button id="suivant_button" class="btn btn-primary pull-right invisible">Suivnat</button>
                    </div>
                    ...
                    <div class="tab-pane" id="placement">
					  ...
					  <button id="retour_button_pla" class="btn btn-primary pull-left invisible">Retour</button>&nbsp;&nbsp;&nbsp;
					  <button id="cancel_edt_button_pla" class="btn btn-primary pull-middle invisible">Annuler</button>
					  <button id="suivant_button_pla" class="btn btn-primary pull-right invisible">Suivnat</button>
					...
					<div class="tab-pane" id="upload_logo">
                      <table class="table"  id="table_upload_logo">
                        <tbody>
                        </tbody>
                      </table>
					  <div id="controle_date_valider" style="color:red; font-weight:bold;"></div> <br/><br/>
					  
					  <button id="retour_button_upl" class="btn btn-primary pull-left invisible">Retour</button>&nbsp;&nbsp;&nbsp;
					  <button id="cancel_edt_button_upl" class="btn btn-primary pull-middle invisible">Annuler</button>
					  <button id="valider_button" class="btn btn-primary pull-right invisible">Valider</button>
