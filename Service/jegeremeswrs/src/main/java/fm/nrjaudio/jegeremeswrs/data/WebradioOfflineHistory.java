...
@Entity
@Table(name = "tb_webradio_offline_history", schema="bobwr")
public class WebradioOfflineHistory {
	
	@Id
	@SequenceGenerator(allocationSize=1, name = "MySeqWebradioOffline", sequenceName = "bobwr.SeqWebradioOffline", initialValue = 5)
    @GeneratedValue(generator = "MySeqWebradioOffline")
	private int pk;
	private int pk_webradio;
	private int id_wr;
	...
	private LocalDate sys_created_offline_history;
	
	private LocalDateTime date_action_request;
	private String id_application_genre;
	...
	public int getPk_webradio() {
		return pk_webradio;
	}
	public void setPk_webradio(int pk_webradio) {
		this.pk_webradio = pk_webradio;
	}
	public int getId_wr() {
		return id_wr;
	}
	...
	public String getId_application_genre() {
		return id_application_genre;
	}
	public void setId_application_genre(String id_application_genre) {
		this.id_application_genre = id_application_genre;
	}
	public LocalDate getSys_created_offline_history() {
		return sys_created_offline_history;
	}
	public void setSys_created_offline_history(LocalDate sys_created_offline_history) {
		this.sys_created_offline_history = sys_created_offline_history;
	}
	public WebradioOfflineHistory() {
		super();
		// TODO Auto-generated constructor stub
	}
	public WebradioOfflineHistory(int pk, int pk_webradio, int id_wr, String nom_wr, int id_pressplay, String claim,
			boolean pub, String logo_emplacement, int id_radio, int id_country, int id_orange_genre,
			int id_itunes_genre, int id_orange_ssgenre, LocalDateTime date_creation_request,
			LocalDateTime date_deletion_request, LocalDateTime sys_created_date, LocalDateTime sys_modified_date,
			LocalDate sys_created_offline_history, LocalDateTime date_action_request, String id_application_genre,
